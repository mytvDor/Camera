...
// <h3 className="text-black text-xl font-semibold leading-8 md:text-start text-center">swicecilia@gmail.com</h3>
// </div>
// <div>
// <h6 className="text-gray-500 text-sm font-medium leading-5 pb-3 md:text-start text-center">Phone Number</h6>
// <h3 className="text-black text-xl font-semibold leading-8 md:text-start text-center">+65 80399982 | 80399973</h3>
// </div>
// </div>
// </div>
